      ...
      <ul className="flex flex-wrap gap-3">
        {hobbies.map((hobby, i) => (
          <Reveal as="li" key={hobby.name} delay={i * 40}>
            <span className="inline-flex items-center gap-2.5 border border-border px-4 py-2.5 text-sm text-muted-foreground transition-colors hover:border-primary hover:text-foreground">
